    ...
    <div className="flex min-h-screen bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      >
        ...
        <nav className="flex-1 space-y-0.5 p-3">
          <a
            href="#"
            className="flex items-center gap-3 rounded-lg bg-amber-50 px-3 py-2.5 text-sm font-medium text-amber-800 dark:bg-amber-950/50 dark:text-amber-200"
          >
            <svg
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"
              />
            </svg>
          ...
          <a
            href="#temas"
            className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-slate-600 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200"
          >
            <svg
        ...
        <div className="border-t border-slate-200 p-3 dark:border-slate-800">
          {sidebarAbierto && profile && (
            <div className="space-y-1 text-xs text-slate-600 dark:text-slate-400">
              <p className="font-medium text-slate-800 dark:text-slate-200 truncate" title={profile.nombre ?? user.email ?? ""}>
          ...
          {sidebarAbierto && !profile && (
            <p className="text-xs text-slate-500 dark:text-slate-400">Monitoría de investigación</p>
          )}
        </div>
      </aside>
